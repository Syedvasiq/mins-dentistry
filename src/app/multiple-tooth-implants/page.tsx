...
export const metadata: Metadata = {
  title: "Multiple Tooth Implants | MINS Dentistry",
  description: "Restore multiple missing teeth with implant-supported solutions at MINS Dentistry.",
};

const highlights = [
  { value: "Stable", label: "Fixed implant-supported replacement" },
  { value: "Natural", label: "Seamless smile restoration" },
  { value: "Functional", label: "Full chewing and bite support" },
  { value: "Planned", label: "Personalised for each case" },
];
const benefits = [
  "Replaces multiple teeth without removable appliances",
  "Preserves jawbone in all missing tooth areas",
  "Restores full chewing efficiency and comfort",
  "Custom restorations blend naturally with your smile",
  "Avoids altering healthy adjacent teeth",
  "Long-lasting result with proper maintenance",
];
const process = [
  { step: "01", title: "Comprehensive assessment", description: "We evaluate the number of missing teeth, bone condition, and bite to plan the most effective implant strategy." },
  { step: "02", title: "Implant placement", description: "Multiple implants are strategically placed to support individual crowns or an implant-supported bridge." },
  { step: "03", title: "Healing period", description: "The implants integrate with the jawbone over time, creating a stable foundation for the final restorations." },
  { step: "04", title: "Final restorations", description: "Custom crowns or a bridge are attached to the implants, completing your smile with a natural, functional result." },
];

export default function MultipleToothImplantsPage() {
  return (
    <main className="bg-[#F7F1E8] text-[#1F1A17]">
      <section className="relative isolate overflow-hidden rounded-b-[2rem] sm:rounded-b-[2.5rem]">
        <div className="absolute inset-0">
          <Image src="/implants/multiple-tooth-implant.png" alt="Multiple tooth implants at MINS Dentistry" fill priority className="object-cover" />
        ...
        <div className="relative max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 pt-32 sm:pt-36 lg:pt-40 pb-20 sm:pb-24 lg:pb-28">
          <nav className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.3em] text-white/50 mb-6" style={{ fontFamily: "monospace" }}>
            ...
            <span className="text-white/30">/</span>
            <span className="text-[#D6B15A]">Multiple Tooth Implants</span>
          </nav>
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold leading-[1.05] text-white">Multiple Tooth Implants for a Complete, Stable Smile</h1>
            <p className="mt-6 text-[15px] sm:text-[16px] leading-relaxed text-white/80 max-w-2xl">When several teeth are missing, implant-supported solutions offer a stable, permanent alternative. MINS Dentistry designs each case individually to restore your bite, speech, and confidence.</p>
      ...
      <section className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 py-16 sm:py-20 lg:py-24">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-16 items-start">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1F1A17] mb-5">Restoring multiple missing teeth with precision</h2>
            <p className="text-[15px] leading-relaxed text-[#5F574D] max-w-2xl">Multiple tooth implants can replace several missing teeth using individual implants or an implant-supported bridge. This approach avoids the need for removable dentures and preserves the health of adjacent teeth.</p>
            <p className="mt-4 text-[15px] leading-relaxed text-[#5F574D] max-w-2xl">At MINS Dentistry, each multiple tooth implant case is planned carefully to achieve the best balance of function, aesthetics, and long-term stability.</p>
          </div>
          <div className="rounded-[1.75rem] border border-[#E6D8BC] bg-[#FCF8F1] p-6 sm:p-8 shadow-[0_20px_60px_rgba(44,31,10,0.06)]">
            <h3 className="text-lg font-semibold text-[#1F1A17] mb-4">Multiple tooth implants may be ideal when</h3>
            <ul className="space-y-4 text-[15px] leading-relaxed text-[#5F574D]">
              <li>Several teeth are missing in one or both arches.</li>
              <li>You want a fixed, permanent replacement option.</li>
              <li>Sufficient bone support is available for implant placement.</li>
              <li>You want to avoid removable partial dentures.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 pb-16 sm:pb-20 lg:pb-24">
        <div className="rounded-[2rem] bg-[#1F1A17] px-6 sm:px-8 lg:px-12 py-10 sm:py-12 lg:py-14">
          <div className="max-w-3xl mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-white mb-4">How multiple tooth implant treatment is planned</h2>
            <p className="text-[15px] leading-relaxed text-white/75">Each stage is carefully managed to ensure proper healing, integration, and a final result that restores your smile completely.</p>
          </div>
      ...
      <section className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 pb-24">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-8 lg:gap-12 items-stretch">
          <div className="rounded-[1.75rem] border border-[#E8DCC6] bg-[#FCF8F1] p-8 sm:p-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1F1A17] mb-5">Why multiple tooth implants are the preferred solution</h2>
          ...
          <div className="rounded-[1.75rem] bg-[linear-gradient(135deg,#B8912A_0%,#8D6A1D_100%)] p-8 sm:p-10 text-white shadow-[0_20px_60px_rgba(120,88,23,0.2)]">
            ...
            <h3 className="text-2xl sm:text-3xl font-semibold mb-4">Restore your smile with a permanent implant solution</h3>
            <p className="text-[15px] leading-relaxed text-white/85 max-w-xl">Our team will assess your missing teeth, bone condition, and smile goals to recommend the most suitable multiple tooth implant plan for you.</p>
            <div className="mt-8 flex flex-wrap gap-4">
